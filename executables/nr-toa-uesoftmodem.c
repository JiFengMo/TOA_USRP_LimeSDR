...
int main(int argc, char **argv)
{
  ...
  printf("NR-TOA UE cfg: sdr=%s clock=%s time=%s band=%d f=%0.f Fs=%0.f rx_gain=%0.1f tx_gain=%0.1f mode=%u meas_mode=%u full_band_sweep=%u strict_center_freq=%u gain_sweep=%u target_pci=%d ssb_scs=%ukHz anchor_db_path=%s n_anchors=%d\n",
         ue.app_cfg.sdr,
